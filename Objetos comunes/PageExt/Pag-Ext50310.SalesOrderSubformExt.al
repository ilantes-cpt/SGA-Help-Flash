pageextension 50310 "Sales Order Subform Ext" extends "Sales Order Subform"
{
    actions
    {
        ...
        addlast("&Line")
        {
            action(AsignaContLantes)
            {
                ...
                begin
                    ...
                    psel.EstablecerDocnew('PVENTA', Rec."Document No.", rec."Line No.", Rec."Qty. Shipped (Base)" + Rec."Qty. to Ship (Base)", rec."Location Code", Rec."No.", '', '', FALSE);
                    //end else
            ...
            /*action(AsignarCont)
            {
                ...
                begin
                    ...
                    rContCont.SetRange("Nº producto", Rec."No.");
                    ...
                    if pContCont.RunModal() = ACTION::LookupOK then begin
                                    ...
                                    if rContenedor.Get(rContCont."Código") then begin
                                        if rContSetup."Tipo pallet" = rContenedor.Tipo then begin
                                            if rContCont.Count > Rec."Qty. to Ship" then begin
                                                ...
                                                rContCont.Validate(PedVenta, Rec."Document No.");
                                                rContCont.Validate(LinPedVenta, Rec."Line No.");
                        ...
                        Rec.Validate("Qty. to Invoice", dCant);
                        Rec.Modify(true);
                    end;
                end;
            }*/
